...
import com.audiolearning.app.adapter.recycler.selectable.base.BaseSelectableRecyclerViewAdapter.BaseSelectableViewHolder
...
abstract class BaseSelectableRecyclerViewAdapter<T : BaseEntity> :
    ...
    abstract inner class BaseSelectableViewHolder(
         ...
         */
        abstract fun showViewSelectedUi()

        /**
         * Change the UI to the state where it is deselected.
         */
        abstract fun showViewDeselectedUi()
    }
}
